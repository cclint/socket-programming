...
localhost = '' # since this is empty, is uses the whole network 
...
listenSocket = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #specify's the network family (IPV4) and connection type (SOCK_STEAM -> TCP)
